...
namespace DataStructure
{
    ...
    public class MyCollection
    {
        public class SinglyLinkedList
        {
            ...
            {
                ////current refference pointing the head at first
                Node temp = head;
                ////creat counter variable to count the node
                int count = 0;
        ...
        /// <summary>
        /// This is the main class of Queue
        /// where Node is a chiled class 
        /// </summary>
        public class Queue
        {
            public Node front;
